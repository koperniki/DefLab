// ******************************************************************************************************
// <copyright file="ModelExponential.cs" company="Caroso.inc">
...
namespace DefLab.common.kriging.semivariances {
    ...
    /// Model Exponential
    /// </summary> 
    public class ModelExponential : BaseKrigingModel, IKrigingModel {
        /// <summary>
        /// Gets the name 
        /// </summary>
        public string Name
        ...
        {
            get { return KrigingModelType.exponential; }
        }
        ...
        public double getValue(double distance) {
            ...
            return Nugget + (Sill*(1 - Math.Exp(-3*Math.Abs(distance)/Range)));
        }
    }
}